...
public sealed class ThemeService
{
    ...
    private static Palette BuildPalette(Color accent, bool dark)
    {
        ...
        var p = new Palette
        {
            ...
            // Light mode strategy: bg is a tinted wash, panels/cards stay pure white so they pop.
            // Dark mode strategy: bg is near-black, panels/cards lift incrementally.
            Bg            = dark ? Surface(0.03, 0.0)  : Surface(0.07, 0.03),
            BgAlt         = dark ? Surface(0.02, 0.0)  : Surface(0.05, 0.02),
            Panel         = dark ? Surface(0.05, 0.03) : Surface(0.0,  0.0),
            Card          = dark ? Surface(0.04, 0.04) : Surface(0.0,  0.0),
            CardHover     = dark ? Surface(0.08, 0.08) : Surface(0.05, 0.04),
            Input         = dark ? Surface(0.03, 0.0)  : Surface(0.04, 0.025),

            Line          = dark ? Surface(0.08, 0.08) : Surface(0.10, 0.10),
            LineSoft      = dark ? Surface(0.05, 0.05) : Surface(0.07, 0.07),

            ButtonBg      = dark ? Surface(0.04, 0.05) : Surface(0.03, 0.02),
            ButtonBorder  = dark ? Surface(0.08, 0.10) : Surface(0.09, 0.09),
            ButtonHover   = dark ? Surface(0.10, 0.10) : Surface(0.06, 0.05),
            ControlBg     = dark ? Surface(0.05, 0.06) : Surface(0.04, 0.03),
            ControlBorder = dark ? Surface(0.08, 0.10) : Surface(0.09, 0.09),
            ProgressTrack = dark ? Surface(0.05, 0.0)  : Surface(0.06, 0.06),
            ToastBg       = dark ? Surface(0.08, 0.10) : Surface(0.0,  0.0),
